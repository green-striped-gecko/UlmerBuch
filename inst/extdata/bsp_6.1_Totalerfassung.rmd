...
Mithilfe der oben erstellten Funktion `est.N` können wir nun unter Angabe der Anzahl Teilflächen und den Erfassungsdaten die Gesamtzahl berechnet werden.
```{r}
