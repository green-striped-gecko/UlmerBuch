...
Im Datensatz beschreiben die Spalten `Native, Planted, Wetland` und `Roadside` vier verschiedenen Habitate. Wir kreieren daraus eine Habitatvariable mit vier Leveln, die als Gruppenvariable genutzt werden kann. Dazu nutzen wir die vereinfacthe Schreibweise aus dem R-Paket dplyr (Wickham et al. 2023).
