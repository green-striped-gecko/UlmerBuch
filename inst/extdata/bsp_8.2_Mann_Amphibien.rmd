...
Der Test kann zweiseitig (alternative=“two.sided”, Hypothese: Es gibt einen Trend nach oben oder unten) und auch einseitig durchgeführt werden (alternative =“greater” oder “less”, Hypothese: Es gibt einen zunehmenden oder abnehmenden Trend). Wir verwenden hier die Version des Tests dass die Erdkrötenpopulation am Wasserwerk Hedem einen abnehmenden Trend zeigt.
