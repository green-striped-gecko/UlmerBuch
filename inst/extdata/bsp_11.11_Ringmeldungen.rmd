...
Hier stellen wir einen Ringfund-Datensatz von Stockenten im San Luis Valley in Colorado vor. Bei diesem Datensatz werden Jung- und Alttiere unterschieden [Modell H1 von Brownie et al. (1985)]. Dazu nutzen wir den Datensatz `brownie`, der im R-Paket RMark enthalten ist (Laake 2013). Erläuterungen finden sich in Laake & Rexstad (2013).
