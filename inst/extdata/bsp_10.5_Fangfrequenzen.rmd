...
# Schauen wir uns die ersten sechs Zeilen an:
head(GV.2016)
```
Individuum 1 wurde also viermal gefangen, Individuum 2 sechsmal, Individuum 3 zweimal und so weiter. Achtung: Die Individuennummerrierung ist nur ein Zeilenname, keine gesonderte Spalte.

Die Anzahl gefangener Individuen beträgt demnach:
```{r}
# Anzahl der Zeilen
nrow(GV.2016)
```
